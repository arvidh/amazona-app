...
export const userSigninReducer = (state = {}, action) =>{
    switch(action.type){
        ...
        case USER_SIGNIN_SIGNOUT: return {}
        default: return state
    }
}
...
export const userDetailsReducer = (state = {loading: true}, action) => {
    switch(action.type){
        ...
        case USER_DETAILS_RESET: return {loading: true}
        default: return state
    }
}
...
export const userUpdateProfileReducer = (state = {}, action) => {
    switch(action.type) {
        ...
        case USER_UPDATE_PROFILE_SUCCESS: return {loading: false, success: true}
...
export const userTopSellerListReducer = (state = {loading: true}, action) => {
    switch(action.type){
        case USER_TOPSELLERS_REQUEST: return { loading: true}
        case USER_TOPSELLERS_SUCCESS: return {loading: false, users: action.payload}
        case USER_TOPSELLERS_FAIL : return {loading: false, error: action.payload}
        default: return state
    }
}