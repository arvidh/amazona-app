...
export const productUpdateReducer = (state = {}, action) => {
    switch(action.type) {
        ...
        case PRODUCT_UPDATE_SUCCESS: return {loading: false, success: true}
...
export const productCategoryListReducer = (state = { loading: true, products: []}, action) =>{
    switch(action.type){
        case PRODUCT_CATEGORY_LIST_REQUEST: return {loading: true}
        case PRODUCT_CATEGORY_LIST_SUCCESS: return {loading: false, categories: action.payload}
...
export const productReviewCreateReducer = (state = {}, action ) => {
    switch (action.type) {
        ...
        case PRODUCT_REVIEW_CREATE_SUCCESS: return {loading: false, success: true, review: action.payload}
